...
// task
Mock.mock(/\/task\/list/, "post", taskAPI.taskList);
Mock.mock(/\/task\/add/, "post", taskAPI.addItem);
Mock.mock(/\/task\/delete/, "post", taskAPI.deleteItem);
Mock.mock(/\/task\/edit/, "post", taskAPI.editItem);
